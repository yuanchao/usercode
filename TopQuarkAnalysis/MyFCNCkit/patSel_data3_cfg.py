...
triggerSelection_163270   = 'HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v* OR HLT_Ele17_CaloIdT_CaloIsoVL_TrkIsoVL_Ele8_CaloIdT_TrkIdVL_CaloIsoVL_TrkIsoVL_v* OR HLT_Ele17_CaloIdVT_CaloIsoVT_TrkIdT_TrkIsoVT_Ele8_Mass30_v* OR HLT_DoubleMu7_* OR HLT_Mu13_Mu8_v* OR HLT_Mu17_Mu8_v*' # un-prescaled only
triggerSelection_Summer11 = 'HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v* OR HLT_Ele17_CaloIdT_CaloIsoVL_TrkIsoVL_Ele8_CaloIdT_TrkIdVL_CaloIsoVL_TrkIsoVL_v* OR HLT_Ele17_CaloIdVT_CaloIsoVT_TrkIdT_TrkIsoVT_Ele8_Mass30_v* OR HLT_DoubleMu3_v* OR HLT_DoubleMu6_v* OR HLT_DoubleMu7_v*'
...
triggerObjectSelection_Summer11 = 'type("TriggerMuon") && ( path("HLT_Mu15_v*") || path("HLT_Mu17_Mu8_*") || path("HLT_DoubleMu7_*") ) type("TriggerElectron") && ( path("HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_*") )'
